...
import { HeroBanner } from '@site/src/pages/_index.tsx'
...
export default function BlogLayout (props: Props): JSX.Element {
  ...
  try {
    hasPosts = children.some(child => child.props.items.length > 0)
  } catch (error) {
    console.error(error)
    hasPosts = false
  }
    ...
    <Layout {...layoutProps}>
      <div className="container margin-vert--lg">
			...
			<div className={styles.section}>
          	  <Heading as="h1" id='eventsOverview'> Events Overview including Community-Created Events</Heading>
           ...
           <div className={styles.section}>
             <h1 id='offerings'> Upcoming Offerings by CF ProvidersSSD</h1>
           </div>
              </>
            }
           <div className="row">
