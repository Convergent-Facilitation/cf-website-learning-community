...
class LocalTimeFromUTC extends React.Component {
  render() {
    ...
    return (
		<span> <b>{startTime.toLocaleDateString('en-GB', {weekday: 'long',  month: 'short',day: 'numeric', year: 'numeric' })} from {startTime.toLocaleTimeString([], { hour: '2-digit', minute:'2-digit', hour12: false })} ({startTime.toLocaleTimeString([], { hour: '2-digit', minute:'2-digit', })}) to {endTime.toLocaleTimeString([], { hour: '2-digit', minute:'2-digit', hour12: false })} ({endTime.toLocaleTimeString([], { hour: '2-digit', minute:'2-digit', })})</b>, {timeZone} time (<a href={`https://www.timeanddate.com/worldclock/converter.html?iso=${isoDateString}&p1=tz_hast&p2=224&p3=179&p4=133&p5=37&p6=176&p7=tz_hkt&p8=240`}>click for more time zones</a>)</span>
    );
