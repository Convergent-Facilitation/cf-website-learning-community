...
const SUBMIT_URL = 'how-to-engage/ask-for-coaching';
...
function useFilteredUsers() {
  ...
  const [operator, setOperator] = useState<Operator>('ASD');
...
function ShowcaseHeader() {
  return (
    <section className="margin-top--lg margin-bottom--lg text--center">
      <h1>{TITLE}</h1>
  <p>Coaching calls are at the core of how we build capacity. Look at the <a href="/#events-overview">Events Overview</a> to find out when the next is going to happen or request one yourself and contribute this growing library of Coaching Calls!</p>
      <a
      ...
      translate(
        {
          ...
          message: '1 site|{sitesCount} recordings',
        },
        {sitesCount},
      ),
    );
