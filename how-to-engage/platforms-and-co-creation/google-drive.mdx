...
If you are working with others from the community and have a need for a shared space to collaborate on documents and share files, as well as possibly access you recordings, you can use the Community Storage on our Google Drive. 
