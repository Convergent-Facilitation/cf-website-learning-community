...
You can participate in as many spheres as you would like to (of those you have access to). Which sphere you want to engage in depends on what you want to do and what your capacity and integration is. Whereever and how you choose to enagage we invite you to join us in co-creating a learning web with us on Hylo: [Co-Create with us on Hylo ![hylo menu bar logo](/img/hylo-menu-bar.png)](/how-to-engage/platforms-and-co-creation/co-create-on-hylo).
