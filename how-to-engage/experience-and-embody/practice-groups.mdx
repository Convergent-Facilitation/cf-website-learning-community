...
You do not need to sign up to anything, you can just join those sessions via the link in the event. Just jumping in on a call can be intimidating if you don't know any of the people there. Practice Group events on the calendar are usually scheduled from within our [collaborative learning space on Hylo](/how-to-engage/platforms-and-co-creation/co-create-on-hylo). You can let people know through a comment on that event that you are intending to join. 

 If you'd like to receive invites to your email address for practice groups and others events that are scheduled by the community on Hylo you can receive [Calendar Invites](/how-to-engage/platforms-and-co-creation/calendar-invites).
