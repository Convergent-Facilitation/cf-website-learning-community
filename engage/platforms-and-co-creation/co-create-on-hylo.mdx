...
# Co-Create with us on Hylo

## Why join us on Hylo

We want to foster a community of practioners who co-create pathways and resources for people to build Convergent Facilitation capacity. We are currently experimenting with the community platform [Hylo](https://www.hylo.com/) to see if it helps to create the co-creation we envision. Once you have signed up to Hylo and joined the Convergent Facilititation group you can always get back to it by using the little icon at the far right in the top menu bar of the website: ![hylo menu bar logo](img/hylo-menu-bar.png)

## Get Started

:one: Create your account on Hylo :point_right: https://www.hylo.com/signup

:two: Join our Convergent Facilitation group on Hylo :point_right: https://www.hylo.com/groups/convergent-facilitation
...
If you want to learn more about what you can do and how you can engage with Hylo please take a look at the [Hylo User Guide (external link)](https://hylozoic.gitbook.io/hylo/guides/hylo-user-guide) offered by the team bulding Hylo.
