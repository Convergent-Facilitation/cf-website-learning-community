...
authors:
  - roni
  - verene
slug: 2024-06-05-thresholds-roni-verene
---
import LocalTime from '@site/src/components/LocalTime';

![pig resting on hand that is coming out of a branch](/img/thresholds-pig-hand-branch-small.webp)


**In this workshop, we invite you to bring more awareness and choice into setting thresholds. We will support you to hone your skills so you can more easily come up with helpful language when you need it.**

[Session 1](2024-06-05-thresholds-roni-verene#1st-session-jun-05-input-and-live-practice):  <LocalTime year={2024} month={6} day={5} startHour={15} startMinute={0} endHour={18} endMinute={0}/>  
[Session 2](2024-06-05-thresholds-roni-verene#2nd-session-jun-12-qa-and-more-practice): <LocalTime year={2024} month={6} day={12} startHour={15} startMinute={0} endHour={17} endMinute={0}/>
...
:::info
Registration for this event is not yet open. Sign up to our [Grow CF Capacity Newsletter](/contact#grow-cf-capacity-newsletter) to hear when we've opened it!
:::
