...
:::tip Access to Workshop Materials and Info
   
    
🔐Access **[Important Infos & Links: Choosing Supportive Thresholds (CST) Workshop](https://community.convergentfacilitation.org/t/important-infos-links-choosing-supportive-thresholds-cst-workshop/198)** (requires registration).

**For questions** you can reach out at any time to the workshop organizers directly via [cst1-support@convergentfacilitation.org](mailto:cst1-support@convergentfacilitation.org).
:::
